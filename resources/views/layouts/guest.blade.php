...
<body
    ...
    <div class="min-h-screen flex flex-col justify-center items-center px-4 py-12 relative z-10">
        ...
        <div class="w-full max-w-md relative">
            ...
            <div class="absolute -bottom-4 -right-4 w-72 h-72 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"
            ...
            <div class="glass-card rounded-2xl shadow-2xl overflow-hidden relative z-10 border border-white/20">
                ...
                <div class="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 p-6 text-center">
                    <div
                        class="w-16 h-16 bg-white/20 rounded-full mx-auto mb-4 flex items-center justify-center backdrop-blur-sm">
