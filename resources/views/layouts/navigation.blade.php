<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-sm"
    style="z-index: 1000; position: fixed; top: 0; left: 0; width: 100%;">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('feed') }}" class="flex items-center space-x-2">
                        ...
                        <span
                            class="text-xl font-bold text-gray-800 dark:text-gray-200 hidden sm:block">SocialConnect</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('messages.index')" :active="request()->routeIs('messages.*')"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium relative">
                        <svg class="w-4 h-4 me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4 sm:ms-6">
                ...
                <div class="relative">
                    <input type="text" placeholder="Search..."
                        class="bg-gray-100 dark:bg-gray-700 rounded-full px-4 py-2 pl-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-200">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <!-- User Avatar -->
                            <div
                                class="w-8 h-8 bg-gray-300 dark:bg-gray-600 rounded-full me-2 flex items-center justify-center">
